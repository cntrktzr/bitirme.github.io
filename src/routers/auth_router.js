...
router.get('/register', authMiddleware.notLoggedIn ,authController.registerForm);
router.post('/register', authMiddleware.notLoggedIn ,validatorMiddleware.validateNewUser(),authController.register);

router.get('/forget-password', authMiddleware.notLoggedIn ,authController.forgetPasswordForm);
